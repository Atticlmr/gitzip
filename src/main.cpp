...
void printUsage() {
    std::cout
        ...
        << "  --ignore-file <file>   Root ignore file. Default: <source>/.gitignore.\n"
        << "  --format <7z|xz>       Archive format. Default: 7z.\n"
        << "  --level <1-9>          Compression level for the embedded 7-Zip core.\n"
        << "  --threads <N>          Compression thread count.\n"
        << "  --password <text>      Enable archive encryption for 7z only.\n"
        ...
        << "Behavior notes:\n"
        << "  - Reads .gitignore files from the root and nested directories.\n"
        << "  - Skips any .git directory and .git file in nested repositories.\n"
